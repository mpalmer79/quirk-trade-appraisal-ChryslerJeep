...
function bootstrapCommonMakesIfEmpty() {
  ...
  const common = [
    "Chevrolet","GMC","Chrysler Jeep","Ram","Toyota","Honda","Nissan","Hyundai","Kia",
    "Jeep","Volkswagen","Subaru","Chrysler Jeep","BMW","Mercedes-Benz","Audi","Dodge",
...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Chrysler Jeep Braintree Braintree"],
    ["successTitle", "¡Gracias! - Quirk Chrysler Jeep Braintree Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Chrysler Jeep Braintree Braintree se pondrá en contacto con usted en breve."]
  ]);
